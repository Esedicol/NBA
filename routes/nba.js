let models = require('../models/nba');
let express = require('express');
let router = express.Router();
let mongoose = require('mongoose');
let uriUtil = require('mongodb-uri');

var mongodbUri ='mongodb://emmanuelsedicol:20072377jp@ds255260.mlab.com:55260/donationsdb';
...
router.findPlayers = (req, res) => {
    
    res.setHeader('type' , 'application/json');
    
    models.find( function (err) {
        
    } {
        
    })

    models.find(function(err, donations) {
        if (err)
            res.send(err);
